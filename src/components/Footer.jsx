  ...
  return (
    <div className="w-full mt-24 bg-slate-900 text-gray-300 py-8 px-2">
        <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6  border-b-2 py-8">
            ...
            <div className="flex-col px-2 py-4 max-w-[1240px]  m-auto  justify-between sm:flex-row items-center text-center text-gray-500">
                <p>Copyright ©{new Date().getFullYear()} || All rights reserved Awesome LLC </p>
